...
const COLUNAS =
  'id, name, description, duration_min, buffer_before_min, buffer_after_min, price_cents, cycle_days, deposit_bps, deposit_min_cents, parallel_capacity, requires_anamnesis, bookable_online, active, position, category_id'
...
export const EsquemaServicoParcial = EsquemaServico.partial()
