        ...
        */}
        {linkNaoCopiado ? (
          <div className="mb-4 flex flex-col gap-2 rounded-[var(--radius-sm)] border border-line-2 bg-surface-2 p-3">
            {/*
              `htmlFor`/`id` em vez de só o `<p>` acima: para quem usa leitor de tela, um campo de
              texto sem rótulo associado é anunciado como "editar texto", sem dizer de quê — e este
              campo guarda a ÚNICA cópia do link de convite que existe na tela.
            */}
            <label htmlFor={ID_LINK_CONVITE} className="text-label font-semibold text-txt-2">
              Link do convite
            </label>
            <input
              id={ID_LINK_CONVITE}
