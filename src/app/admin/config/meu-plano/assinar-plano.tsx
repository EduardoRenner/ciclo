 ...
 * (a página decide isso, não este componente). Sem a credencial, a tela mantém o link de
 * WhatsApp ("Quero o {plano}"), pela regra 5.4 do `docs/18`: não fingir que a cobrança
 * automática existe.
 *
