...
export default async function PaginaFicha({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <Ficha
      ...
      // Mesma trava de `POST /api/v1/clients/[id]/subscription` (`club`, plano Avançado). Sem
      // isto, um tenant que caiu de degrau depois de já ter criado planos (regra 5.1: cair de
      // plano nunca esconde o que já existe) via um botão "Assinar plano" que o servidor recusa.
      bloqueadoClube={podeUsarModulo(plano, 'club').estado !== 'liberado'}
